...
**Difficulty:** Medium  
**Topics:** Divide and Conquer, Tree, Binary Tree  
...
1. If the current grid has the same value (i.e. all 1's or all 0's) set `isLeaf` to `True` and set `val` to the value of the grid and set the four children to `null` and stop.
